...
use zed_actions::{debug_panel, dev, git_panel, project_panel, Quit};
...
pub fn app_menus(cx: &mut App) -> Vec<Menu> {
    ...
    vec![
        Menu {
            name: "Light Code".into(),
            disabled: false,
            items: vec![
                MenuItem::action("About Light Code", zed_actions::About),
                MenuItem::separator(),
                ...
                MenuItem::separator(),
                MenuItem::action("Quit Light Code", Quit),
            ],
        },
        Menu {
            name: "File".into(),
