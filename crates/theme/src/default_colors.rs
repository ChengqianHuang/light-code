...
impl ThemeColors {
    ...
    pub fn light() -> Self {
        ...
        Self {
            ...
            title_bar_background: neutral().light().step_1(),
            title_bar_inactive_background: neutral().light().step_1(),
    ...
    pub fn dark() -> Self {
        ...
        Self {
            ...
            title_bar_background: neutral().dark().step_1(),
            title_bar_inactive_background: neutral().dark().step_1(),
